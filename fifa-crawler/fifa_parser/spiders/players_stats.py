...
class SofifaSpider(scrapy.Spider):
    ...
    def parse(self, response):
        for player in response.css('.info'):
            ...
            player_tags = player.xpath('//div[@class="player"]//div//a//mark/text()').getall()
            player_operation = player.xpath('//div[@class="operation"]//a/text()').re(r'\w+')
            player_operation_values = player.xpath('//div[@class="operation"]//a//span/text()').getall()
            ...
            player_skills_values = player.xpath('//div[@class="columns"]//div//div//ul/li//span/text()').getall()
